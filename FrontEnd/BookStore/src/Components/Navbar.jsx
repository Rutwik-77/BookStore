...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl z-10 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 ${
          sticky
            ? "sticky-navbar shadow-lg bg-slate-100 duration-500 transition-all ease-in-out"
            : ""
        }`}
      >
        <div className='navbar'>
          ...
          <div className='navbar-end space-x-3 '>
...

            {
              authUser ? <Logout/> :
             <div className=''>
              <a className='rounded-md hover:bg-slate-800 cursor-pointer duration-200  px-4 py-2.5 bg-black text-white dark:bg-white dark:text-black' onClick={() => document.getElementById("my_modal_3").showModal()}>
                Login
              </a>
              <Login></Login>
            </div> 
